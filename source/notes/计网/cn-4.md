...
![Traditional Approach](cn-4/plane-traditional.png)
...
![SDN Approach](cn-4/plane-sdn.png)
...
![Router Architecture](cn-4/router-architecture.png)
...
![Input Processing](cn-4/input-processing.png)
...
![Via Memory](cn-4/switch-memory.png)
...
![Via CrossBar](cn-4/switch-crossbar.png)
...
![Output Processing](cn-4/output-processing.png)
...
![Output Queueing](cn-4/output-queueing.png)
...
![Fragmentation](cn-4/ip-fragmentation.png)
...
![Tunneling](cn-4/tunnel.png)

## 4.5 Generalized Forwarding and SDN

![Generalized Forwarding](cn-4/generalized-forwarding.png)
